...
#project(
  name: "빌링 3.0 출시 및 고도화",
  // Role is optional
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2025년 7월", end-date: "진행중"),
...
- 고객사별 설정에 따른 청구서별 과세/면세/영세율 계산서 단건 및 다건 발행 및 취소 기능 개발.
- ASP.NET Core, SQL Server, MySQL, EF Core, Azure Container Apps 등 활용

#project(
  name: "RITA - 예약 인스턴스 구입 업무 데이터 검증 시스템",
  // Role is optional
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2025년 3월", end-date: "2025년 6월"),
  // URL is also optional
  url: "",
)
- 클라우드 예약 인스턴스 구입 프로세스 자동화 및 데이터 정합성 검증 시스템 구축
...
#project(
  name: "mateBilling 2.0 고객사 클라우드 빌링 데이터 수집 파이프라인 개발 PoC",
  // Role is optional
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2022년 2월", end-date: "2023년 12월"),
  // URL is also optional
  url: "",
)
- 기존 빌링 수집 프로세스의 문제점과 한계를 개선하기 위한 검증 작업
...
- 데이터 수집 단계와, 실제 DB에 넣는 단계와 이에 따른 책임을 분리. 수집 워크플로우가 잘못된 데이터 DB에 바로 넣는 문제 차단
...
#project(
  ...
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2022년 2월", end-date: "2022년 8월"),
  // URL is also optional
  url: "",
)
...
#project(
  name: "mateBilling 2.0 개발",
  // Role is optional
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2020년 12월", end-date: "2022년 1월"),
  // URL is also optional
  url: "",
)
...
#project(
  name: "RPM (Resource Power Manager) 서비스 개발",
  // Role is optional
  role: "",
  // Dates is optional
  dates: dates-helper(start-date: "2023년 3월", end-date: "2023년 8월"),
  // URL is also optional
  url: "",
)
